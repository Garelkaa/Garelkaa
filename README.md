...
Bogdan Stashchuk та вебінарів GoIT де і здобув фундамент знань. Зараз я розвиваюсь в напрямках веб-розробки(Django, Flask, React), AI, TelegramAPI(aiogram) та ін.
